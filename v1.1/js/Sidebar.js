  ...
  (function () {
    ...
    page.addComponent(
      ...
      new ComponentSlider({
        ...
        options: [1, -1],
        oninput: function (value) {
          if (Edge.defaultStrength !== 3 || value !== 1) {
            if (Edge.defaultStrength !== -3 || value !== -1) {
    ...
    page.addComponent(
      ...
      new ComponentSlider({
        ...
        options: [1, -1],
        oninput: function (value) {
          if (Edge.defaultAllowance === 0) {
            Edge.defaultAllowance = value;
          } else {
    ...
    page.addComponent(
      new ComponentHTML({
        html: "(to make a delayed relationship, draw longer arrows)",
      })
    );
    page.addComponent(
      new ComponentButton({
    ...
    page.onedit = function () {
      ...
      Sidebar.edgeEditingIndex = edge.id;
    };
